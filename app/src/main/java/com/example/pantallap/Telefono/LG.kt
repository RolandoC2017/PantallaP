...
class LG : Fragment() {
    ...
    override fun onCreateView(
        ...
        productos.add(ProductosCardView("LG STYLUS 3 3GB RAM 16GB 13MP - titanio","S/ 899.00","469",R.drawable.lgstylus,"ANDROID 10"))
        productos.add(ProductosCardView("LG Smartphone 6.5 K51S 3GB 64GB 5 Camaras LM-K510HM - Titan","S/ 997.00","697",R.drawable.lgsmartphone,"ANDROID 10"))
        productos.add(ProductosCardView("LG VELVET 5G AURORA PLATA CELULAR","S/ 2,999.00","1499.00",R.drawable.lgvelvet,"ANDROID 10"))
        productos.add(ProductosCardView("LG K20 16GB 1GB RAM - Negro","S/ 690.00","389",R.drawable.lgk20,"ANDROID 10"))
