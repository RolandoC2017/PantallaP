...
class Huawei : Fragment() {
    ...
    override fun onCreateView(
       ...
       // linear!!.setOnClickListener { startActivity(Intent(context, InfoHuawei1::class.java)) }
        ...
        productos.add(ProductosCardView("Huawei Mate 30 Pro 256GB 8GB RAM Plata","S/ 4,599.00","3299.00",R.drawable.huaweimate,"ANDROID 10"))
        productos.add(ProductosCardView("Huawei P40 128GB 8GB AZUL","S/ 2,699.00","2399.00",R.drawable.huaweip40,"ANDROID 10"))
        productos.add(ProductosCardView("Huawei P30 Pro 256GB-Black","S/ 3,999.00","2799.00",R.drawable.huaweip30,"ANDROID 10"))
        productos.add(ProductosCardView("HUAWEI Y9A 128gb 6gb Ram Dual Sim","S/ 1,299.00","1250.00",R.drawable.huaweiy9,"ANDROID 10"))
